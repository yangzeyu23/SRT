classdef coreASMLayer < nnet.layer.Layer %#codegen
    ...
    methods
        function layer = coreASMLayer(inputSize,coreMask,Hr,Hi,NameValueArgs)
            ...
            layer.Description = "Angular spectrum method";
...
%             lgraph = connectLayers(lgraph,'sin','sinshift');
            ...
            lgraph = connectLayers(lgraph,'cosmask','Fcos');
            lgraph = connectLayers(lgraph,'sinmask','Fsin');
